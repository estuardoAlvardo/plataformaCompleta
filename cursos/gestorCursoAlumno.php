...
//buscar temas de curso si no me equiboco es del tab 1
...
<html lang="es">
  <head>
    ...
    <title><?php echo $_SESSION["nombre"]; ?> | Gestor Cursos</title>
  ...
  <div class="tab-content">
    ...
    <div class="portada col-md-12" style="height: 200px;  background: url(<?php echo $_SESSION['uriLocal'].$_SESSION['portada']; ?>);">
      ...
      <div class="col-md-6 btnEditarPortada" title="Cambiar Portada" >
        <img class="vibrar" src="https://image.flaticon.com/icons/svg/2489/2489796.svg" width="50" height="50" style="display: none">
        <p style="color: white; padding-right: 7px; display: none;">Editar</p>
...
$horaEntregaTarea= substr($datosTarea2['fechaEntrega'],11,20);
      ...
      $queryTareaEnvie = ("SELECT * FROM cursoGestorTarea where idTarea=:idTarea and idUsuario=:idUsuario");
      $buscarTareasEnvidas = $dbConn->prepare($queryTareaEnvie);
      $buscarTareasEnvidas->bindParam(':idTarea',$datosTarea2['idTarea'], PDO::PARAM_INT);
      $buscarTareasEnvidas->bindParam(':idUsuario',$_SESSION['idUsuario'], PDO::PARAM_INT);
      $buscarTareasEnvidas->execute();
      $yaEnvieTareas=$buscarTareasEnvidas->rowCount();

           while ($datosCalificados=$buscarTareasEnvidas->fetch(PDO::FETCH_ASSOC)){

 ?>

<br>
<div class="col-md-12">
<a href="<?php echo 'visorTarea.php?tokenTar='.$datosTarea2['idTarea']; ?>&idCurso=<?php echo $_GET['tokenCourse']; ?>&tokenCourse=<?php echo $_GET['tokenCourse']; ?>&course=<?php echo $_GET['course']; ?>" style="text-decoration: none; color: black"><div class="row boxCard" style=" text-align: left; border-radius: 5px;">
  ...
  <div class="chip-close">
    ...
    <div class="row">
      <div class="col-md-3">
        <h5 style="text-align: center;">Tarea Enviada:<span style="font-weight: bold; font-size: 18pt;">
          <?php 
            if($yaEnvieTareas>=1){
           ?>
          <img src="../img/leido1.png"  width="50" height="50">

        <?php }else{ ?>
                    <img src="../img/enviado1.png" width="50" height="50">
        <?php } ?>
        </span></h5>
        
      </div>
      <div class="col-md-3">
        <h5 style="text-align: center;">Tarea Calificada: <span style="font-weight: bold; font-size: 18pt;">
    ...
    if($datosCalificados['punteo']!=null || !empty($datosCalificados['punteo'])){ ?>
          <img src="../img/leido1.png" width="50" height="50">
      <?php }else{  ?>
                  <img src="../img/enviado1.png" width="50" height="50">
...
<?php }else{ 
  ...
  //Buscamos examenes realizados para  realizo examen
  
  $queryBuscarExamenRealizado = ("SELECT * FROM registroExamenCalificado where idExamen=:idExamen and idUsuario=:idUsuario ");
  $buscarExamenRealizado = $dbConn->prepare($queryBuscarExamenRealizado);
  $buscarExamenRealizado->bindParam(':idExamen',$datosExamenes['idRegistro'], PDO::PARAM_INT);
  ...
  $cantidadPreguntas= $conteoPreguntas+$conteoEmparejamiento+$conteoRespuestaCorta;
    ...
    if($yaRealizoExamen==0){
    $linkExamen='atomoQuiz.php?tokenRegister='.$datosExamenes['idRegistro'].'&tokenCourse='.$_GET['tokenCourse'].'&course='.$_GET['course'];
    $imagen='../img/enviado1.png';
  }else{
   $linkExamen='resultadoPrueba.php?tokenRegister='.$datosExamenes['idRegistro']. '&tokenCourse='.$_GET['tokenCourse'].'&course='.$_GET['course'];
    $imagen='../img/leido1.png';
  }
...
<div class="col-md-12">
<a href="<?php echo $linkExamen; ?> " style="text-decoration: none; color: black"><div class="row boxCard" style=" text-align: left; border-radius: 5px;">
  <div class="col-md-7" style="">
  ...
  <div class="chip-close">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <h5 style="text-align: center;">Examen hecho:</h5>
      ...
      <div class="col-md-3" style="text-align: right; margin-top:10px; display: block">
...
function crearTema(){
 ...
 var datosGuardar= $("#crearTemaF").serialize();
 //alert(datosGuardar);
